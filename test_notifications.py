...
def test_long_message_notification():
    ...
    long_message = "This is a very long message to test how the notification system handles lengthy content. " * 3
...
def test_scheduler_notifications():
    ...
    with patch('notifier.send_notification') as mock_notify:
        ...
        notification_jobs = [job_info for job_info, job_func in jobs if 'notify' in job_info]
...
def main():
    ...
    if passed == total:
        print("🎉 All notification tests passed! The notification system is working correctly.")
        ...
        print(f"⚠️  {total - passed} test(s) failed. Please check the notification system.")
