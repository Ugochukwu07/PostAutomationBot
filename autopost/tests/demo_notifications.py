...
def demo_basic_notifications():
    ...
    send_notification(
        title="Bot Status", message="Automated Poster Bot is running successfully!"
    )
    time.sleep(2)
    ...
    send_notification(title="Upcoming Post", message="A SCHEDULED post is at 12:00")
    time.sleep(2)

    print("\n4. Error notification...")
    send_notification(
        title="Post Error", message="Failed to post content. Retrying in 5 minutes..."
    )
    time.sleep(2)
